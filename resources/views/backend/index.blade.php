...
@section('content')
    ...
    <nav class="navbar mobile-navbar is-hidden-desktop is-hidden-tablet" aria-label="main navigation">
        ...
        <div class="navbar-brand">
            <a class="navbar-item" href="home.html">
                <img src="/images/logo/nephos.svg" alt="">
            </a>
        ...
        <div class="navbar-menu">
            ...
            <div class="navbar-item has-dropdown">
                <a class="navbar-link">
                    <img src="/images/avatars/elie.jpg" alt="">
    ...
    <div class="main-sidebar">
        <div class="sidebar-brand">
            <router-link to="/"><img src="/images/logo/nephos.svg" alt=""></router-link>
        </div>
            ...
            <ul class="category-menu">
                <li>
                    <a href="products.html">
                        <span>House</span> <!--img src="/images/icons/living.svg" alt=""-->
                ...
                <li>
                    <a href="products.html">
                        <span>Office</span> <!--img src="/images/icons/office.svg" alt=""-->
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                <g>
                ...
                <li>
                    <a href="products.html">
                        <span>For kids</span> <!--img src="/images/icons/kids.svg" alt=""-->
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                <g>
                ...
                <li>
                    <a href="products.html">
                        <span>Kitchen</span> <!--img src="/images/icons/kitchen.svg" alt=""-->
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                <g>
                ...
                <li>
                    <a href="products.html">
                        <span>Accessories</span> <!--img src="/images/icons/accessories.svg" alt=""-->
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                <g>
                ...
                <li>
                    <a href="products.html">
                        <span>View All</span> <!--img src="/images/icons/all.svg" alt=""-->
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                            ...
                            <g>
                                <g>
                                    ...
                                    <rect x="261.354" y="228.052"
                                          transform="matrix(0.7071 -0.7071 0.7071 0.7071 -97.5854 265.771)"
                                          width="21.333" height="45.259"/>
                                </g>
                            </g>
                            <g>
                                <g>
    ...
    <!-- Shop quickview -->
    <div class="shop-quickview has-background-image" data-background="/images/bg/sidebar.jpeg">
        <div class="inner">
            <!-- Header -->
