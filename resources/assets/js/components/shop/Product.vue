<template>
    <div class="product">
        ...
        <div class="product-info">
            <a class="product-brand" :href="data.slug" v-if="data.brand">{{data.brand.name}}</a>
            <a :href="data.slug">
        ...
        <a v-else-if="data.variant_count>0" :href="data.slug" class="cart-button add-to-cart" :data-id="data.id">
